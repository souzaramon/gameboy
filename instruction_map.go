...
var InstructionMap = map[byte]Instruction{
	...
	0x80: {IK: IK_ADD, AM: AM_R_R, R1: RK_A, R2: RK_B},
	0x81: {IK: IK_ADD, AM: AM_R_R, R1: RK_A, R2: RK_C},
	0x82: {IK: IK_ADD, AM: AM_R_R, R1: RK_A, R2: RK_D},
	0x83: {IK: IK_ADD, AM: AM_R_R, R1: RK_A, R2: RK_E},
	0x84: {IK: IK_ADD, AM: AM_R_R, R1: RK_A, R2: RK_H},
	0x85: {IK: IK_ADD, AM: AM_R_R, R1: RK_A, R2: RK_L},
	0x87: {IK: IK_ADD, AM: AM_R_R, R1: RK_A, R2: RK_A},
	0x90: {IK: IK_SUB, AM: AM_R_R, R1: RK_A, R2: RK_B},
	0x91: {IK: IK_SUB, AM: AM_R_R, R1: RK_A, R2: RK_C},
	0x92: {IK: IK_SUB, AM: AM_R_R, R1: RK_A, R2: RK_D},
	0x93: {IK: IK_SUB, AM: AM_R_R, R1: RK_A, R2: RK_E},
	0x94: {IK: IK_SUB, AM: AM_R_R, R1: RK_A, R2: RK_H},
	0x95: {IK: IK_SUB, AM: AM_R_R, R1: RK_A, R2: RK_L},
	0x97: {IK: IK_SUB, AM: AM_R_R, R1: RK_A, R2: RK_A},
	0xa0: {IK: IK_AND, AM: AM_R_R, R1: RK_A, R2: RK_B},
	0xa1: {IK: IK_AND, AM: AM_R_R, R1: RK_A, R2: RK_C},
	0xa2: {IK: IK_AND, AM: AM_R_R, R1: RK_A, R2: RK_D},
	0xa3: {IK: IK_AND, AM: AM_R_R, R1: RK_A, R2: RK_E},
	0xa4: {IK: IK_AND, AM: AM_R_R, R1: RK_A, R2: RK_H},
	0xa5: {IK: IK_AND, AM: AM_R_R, R1: RK_A, R2: RK_L},
	0xa7: {IK: IK_AND, AM: AM_R_R, R1: RK_A, R2: RK_A},
	0xa8: {IK: IK_XOR, AM: AM_R_R, R1: RK_A, R2: RK_B},
	0xa9: {IK: IK_XOR, AM: AM_R_R, R1: RK_A, R2: RK_C},
	0xaa: {IK: IK_XOR, AM: AM_R_R, R1: RK_A, R2: RK_D},
	0xab: {IK: IK_XOR, AM: AM_R_R, R1: RK_A, R2: RK_E},
	0xac: {IK: IK_XOR, AM: AM_R_R, R1: RK_A, R2: RK_H},
	0xad: {IK: IK_XOR, AM: AM_R_R, R1: RK_A, R2: RK_L},
	0xaf: {IK: IK_XOR, AM: AM_R_R, R1: RK_A, R2: RK_A},
	0xb0: {IK: IK_OR, AM: AM_R_R, R1: RK_A, R2: RK_B},
	0xb1: {IK: IK_OR, AM: AM_R_R, R1: RK_A, R2: RK_C},
	0xb2: {IK: IK_OR, AM: AM_R_R, R1: RK_A, R2: RK_D},
	0xb3: {IK: IK_OR, AM: AM_R_R, R1: RK_A, R2: RK_E},
	0xb4: {IK: IK_OR, AM: AM_R_R, R1: RK_A, R2: RK_H},
	0xb5: {IK: IK_OR, AM: AM_R_R, R1: RK_A, R2: RK_L},
	0xb7: {IK: IK_OR, AM: AM_R_R, R1: RK_A, R2: RK_A},
	0xb8: {IK: IK_CP, AM: AM_R_R, R1: RK_A, R2: RK_B},
	0xb9: {IK: IK_CP, AM: AM_R_R, R1: RK_A, R2: RK_C},
	0xba: {IK: IK_CP, AM: AM_R_R, R1: RK_A, R2: RK_D},
	0xbb: {IK: IK_CP, AM: AM_R_R, R1: RK_A, R2: RK_E},
	0xbc: {IK: IK_CP, AM: AM_R_R, R1: RK_A, R2: RK_H},
	0xbd: {IK: IK_CP, AM: AM_R_R, R1: RK_A, R2: RK_L},
	0xbf: {IK: IK_CP, AM: AM_R_R, R1: RK_A, R2: RK_A},
